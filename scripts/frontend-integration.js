 ...
 * This file demonstrates how to integrate Bridgeshard with a web frontend
 */

// For React/Vue/Angular applications
export class BridgeshardClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new BridgeshardClient(provider, contractAddress);
