...
const contractABI = require("../artifacts/contracts/Bridgeshard.sol/Bridgeshard.json").abi;

program
    .name("bridgeshard-cli")
    .description("CLI tool for Bridgeshard smart contract")
    .version("1.0.0");
